...
type Payload_OtpParameters struct {
	...
	Algorithm Payload_Algorithm  `protobuf:"varint,4,opt,name=algorithm,proto3,enum=migration.Payload_Algorithm" json:"algorithm,omitempty"`
	Digits    Payload_DigitCount `protobuf:"varint,5,opt,name=digits,proto3,enum=migration.Payload_DigitCount" json:"digits,omitempty"`
	Type      Payload_OtpType    `protobuf:"varint,6,opt,name=type,proto3,enum=migration.Payload_OtpType" json:"type,omitempty"`
...
var file_migration_proto_rawDesc = []byte{
	...
	0x6f, 0x12, 0x09, 0x6d, 0x69, 0x67, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0xf7, 0x05, 0x0a,
	...
	0x61, 0x74, 0x63, 0x68, 0x49, 0x64, 0x1a, 0x90, 0x02, 0x0a, 0x0d, 0x4f, 0x74, 0x70, 0x50, 0x61,
	...
	,
	...
	,
}
...
var file_migration_proto_goTypes = []interface{}{
	(Payload_Algorithm)(0),        // 0: migration.Payload.Algorithm
	(Payload_DigitCount)(0),       // 1: migration.Payload.DigitCount
	(Payload_OtpType)(0),          // 2: migration.Payload.OtpType
...
var file_migration_proto_depIdxs = []int32{
	...
	0, // 1: migration.Payload.OtpParameters.algorithm:type_name -> migration.Payload.Algorithm
	1, // 2: migration.Payload.OtpParameters.digits:type_name -> migration.Payload.DigitCount
	2, // 3: migration.Payload.OtpParameters.type:type_name -> migration.Payload.OtpType
