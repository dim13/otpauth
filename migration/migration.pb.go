...
type Payload struct {
	...
	BatchId       uint32                   `protobuf:"varint,5,opt,name=batch_id,json=batchId,proto3" json:"batch_id,omitempty"`
}
...
func (x *Payload) GetBatchSize() uint32 {
	if x != nil {
		return x.BatchSize
	}
	return 0
...
func (x *Payload) GetBatchIndex() uint32 {
	if x != nil {
		return x.BatchIndex
	}
	return 0
...
func (x *Payload) GetBatchId() uint32 {
	if x != nil {
		return x.BatchId
	}
	return 0
...
func (x *Payload_OtpParameters) GetCounter() int64 {
	if x != nil {
		return x.Counter
	}
	return 0
...
var file_migration_proto_rawDesc = []byte{
	...
	0x73, 0x69, 0x7a, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x09, 0x62, 0x61, 0x74, 0x63,
	0x68, 0x53, 0x69, 0x7a, 0x65, 0x12, 0x1f, 0x0a, 0x0b, 0x62, 0x61, 0x74, 0x63, 0x68, 0x5f, 0x69,
	0x6e, 0x64, 0x65, 0x78, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0a, 0x62, 0x61, 0x74, 0x63,
	0x68, 0x49, 0x6e, 0x64, 0x65, 0x78, 0x12, 0x19, 0x0a, 0x08, 0x62, 0x61, 0x74, 0x63, 0x68, 0x5f,
	0x69, 0x64, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x07, 0x62, 0x61, 0x74, 0x63, 0x68, 0x49,
	...
	0x63, 0x6f, 0x75, 0x6e, 0x74, 0x65, 0x72, 0x18, 0x07, 0x20, 0x01, 0x28, 0x03, 0x52, 0x07, 0x63,
